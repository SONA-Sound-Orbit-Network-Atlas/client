/**
  ...
  @property planetBrightness 행성의 밝기, 0 ~ 10 ? 자체발광? 이럼 항성인데?
  @property distanceFromStar 1.0 ~ 10.0 범위 최적 행성과 항성계의 거리,  // 동일 거리 허용할건가?
  @property orbitSpeed 행성의 공전 속도
  @property rotationSpeed 행성의 자전 속도
  @property inclination -180 ~ 180 행성의 기울기
  @property eccentricity 0.0 ~ 0.9 행성의 이심률
  @property tilt 행성의 기울기
 */
